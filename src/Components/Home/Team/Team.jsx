  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 my-10">
        <div className="card pb-10 rounded-lg border border-[#E8E8E8]">
          <figure className=" px-5 pt-5 rounded-lg">
            <img src={team1} alt="Shoes" className="rounded-xl" />
          </figure>
          <div className="card-body items-center text-center">
            <h2 className="card-title text-2xl font-bold text-[#444]">
              Car Engine Plug
            </h2>
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div //icon-4
             className="bg-red-500 w-10 h-10 rounded-full relative">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none" className="absolute bottom-2 right-2">
                <path d="M15.5104 0.599609H6.82148C3.57347 0.599609 0.93158 3.2415 0.93158 6.48951V15.1784C0.93158 18.4264 3.57347 21.0683 6.82148 21.0683H15.5104C18.7584 21.0683 21.4003 18.4264 21.4003 15.1784V6.48951C21.4003 3.2415 18.7584 0.599609 15.5104 0.599609ZM19.3732 6.48951V15.1784C19.3732 17.3086 17.6405 19.0413 15.5104 19.0413H6.82148C4.69131 19.0413 2.95861 17.3086 2.95861 15.1784V6.48951C2.95861 4.36013 4.69131 2.62744 6.82148 2.62744H15.5104C17.6397 2.62664 19.3732 4.35934 19.3732 6.48951Z" fill="white"/>
                <path d="M11.166 5.52002C8.23613 5.52002 5.85208 7.90406 5.85208 10.8339C5.85208 13.7638 8.23613 16.1479 11.166 16.1479C14.0959 16.1479 16.4799 13.7638 16.4799 10.8339C16.4799 7.90406 14.0959 5.52002 11.166 5.52002ZM14.4521 10.8339C14.4521 12.646 12.978 14.12 11.166 14.12C9.35397 14.12 7.87991 12.646 7.87991 10.8339C7.87991 9.02191 9.35397 7.54785 11.166 7.54785C12.978 7.54785 14.4521 9.02191 14.4521 10.8339Z" fill="white"/>
                <path d="M16.5519 3.9834C15.7855 3.9834 15.1611 4.60698 15.1611 5.37416C15.1611 6.14054 15.7847 6.76492 16.5519 6.76492C17.3183 6.76492 17.9427 6.14134 17.9427 5.37416C17.9419 4.60698 17.3183 3.9834 16.5519 3.9834Z" fill="white"/>
            </svg>
            </div>
          </div>
        </div>
